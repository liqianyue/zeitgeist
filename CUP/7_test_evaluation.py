...
GEO_data=pd.read_csv(loc_path+"GEO_dataset/gene_sel_data/train.csv",header=None)
...
TCGA_test=pd.read_csv(loc_path+"TCGA_dataset/gene_sel_data/test_standard.csv",header=None)
GEO_test=pd.read_csv(loc_path+"GEO_dataset/gene_sel_data/test_standard.csv",header=None)
TCGA_test=TCGA_test.values
GEO_test=GEO_test.values
print(TCGA_test.shape)
print(GEO_test.shape)

TCGA_test_label=pd.read_csv(loc_path+"TCGA_dataset/test_TCGA_label.csv",header=None)
GEO_test_label=pd.read_csv(loc_path+"GEO_dataset/test_GEO_label.csv",header=None)
...
TCGA_val_data.to_csv(loc_path+"/TCGA_dataset/plot/TCGA_test_performaces.csv")

GEO_val_data=pd.DataFrame(data=np.array(GEO_eva_num),index=model_name_GEO,
                           columns=GEO_eva_name)
GEO_val_data.to_csv(loc_path+"/GEO_dataset/plot/GEO_test_performaces.csv")
 ...
 plt.savefig(loc_path+"/TCGA_dataset/plot/TCGA_test_val.jpg",dpi=175)
 ...
 plt.bar(index_knn,height=GEO_val_data.loc['knn',:].values,width=bar_width,
        color='m',label='knn')
 plt.bar(index_svm_lin,height=GEO_val_data.loc['lg',:].values,width=bar_width,
 ...
 plt.ylabel('Accuarcy',size=12)
 plt.savefig(loc_path+"GEO_dataset/plot/GEO_test_val.jpg",dpi=175)
 ...
 TCGA_label_num=15
 GEO_label_num=10
 TCGA_test_ont=np.array([[0]*TCGA_label_num]*len(TCGA_test_label))
 GEO_test_ont=np.array([[0]*GEO_label_num]*len(GEO_test_label))
 ...
 plt.legend(fontsize='x-small',loc='lower right')
 plt.savefig(loc_path+"TCGA_dataset/plot/TCGA_roc_1.jpg",dpi=175)
 ...
 plt.legend(fontsize='x-small',loc='lower right')
 plt.savefig(loc_path+"TCGA_dataset/plot/TCGA_roc_2.jpg",dpi=175)
 ...
 plt.legend(fontsize='x-small',loc='lower right')
 plt.savefig(loc_path+"GEO_dataset/plot/GEO_roc_1.jpg",dpi=175)
 ...
 plt.plot(fpr[7],tpr[7],color='b',lw=lw,label='bone (area=%0.4f)'%roc_aucs[7])
 plt.plot(fpr[8],tpr[8],color='c',lw=lw,label='eye (area=%0.4f)'%roc_aucs[8])
 plt.plot(fpr[9],tpr[9],color='darkcyan',lw=lw,label='others (area=%0.4f)'%roc_aucs[9])
 plt.xlim([-0.03,1.0])
 plt.ylim([0.0,1.05])
 plt.xlabel('False Positive Rate',fontsize='small')
 plt.ylabel('True Positive Rate',fontsize='small')
 ...
 plt.legend(fontsize='x-small',loc='lower right')
 plt.savefig(loc_path+"GEO_dataset/plot/GEO_roc_2.jpg",dpi=175)
